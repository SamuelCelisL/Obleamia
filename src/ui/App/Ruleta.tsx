...
const CustomWheel = () => {
  ...
  const wheelItems = [
    { text: 'Obleamia', weight: 0.8, color: '#FF6B6B' },
    { text: 'Toppings premiun', weight: 1, color: '#4ECDC4' },
    { text: 'Sigue Intentado', weight: 6, color: '#45B7D1' },
    { text: 'Toppings A', weight: 3, color: '#96CEB4' },
    { text: 'Sigue Intentado', weight: 6.2, color: '#DDA0DD' }
  ];
